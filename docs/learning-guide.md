...
code. It assumes you have run the [Quickstart](local-development.md).
...
- **Go to BigQuery.** Follow [production-gcp.md](production-gcp.md)
...
- [ADRs](adr/0001-record-architecture-decisions.md) — why each decision was made.
